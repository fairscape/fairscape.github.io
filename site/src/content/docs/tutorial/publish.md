---
title: Publishing RO-Crate to Dataverse
description: Step-by-step guide for publishing an RO-Crate to a Dataverse instance from FAIRSCAPE.
---
...
1. Go to your RO-Crate metadata page in Fairscape
...
3. Publication Details:
    * Title\*: Verify or update the RO-Crate title
