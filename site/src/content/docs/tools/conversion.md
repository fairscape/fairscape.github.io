---
title: fairscape-conversion
description: "Turn metadata you already have into a FAIRSCAPE RO-Crate."
---
...
- **Try every converter with no data of your own.** `python examples/run_all.py`
  ...
  [`examples/mlflow/mlflow_to_rocrate.ipynb`](https://github.com/fairscape/fairscape_conversion/blob/main/examples/mlflow/mlflow_to_rocrate.ipynb)
...
- **Linking crates.** If this run's inputs were another run's outputs, pass
  ...
  [`examples/linked-crates/`](https://github.com/fairscape/fairscape_conversion/blob/main/examples/linked-crates).
- **Adding a format.** A converter is a folder with two CSV mapping files and
  a small plugin class. See [`docs/NEW-PLUGIN.md`](https://github.com/fairscape/fairscape_conversion/blob/main/docs/NEW-PLUGIN.md),
  [`docs/INTERNALS.md`](https://github.com/fairscape/fairscape_conversion/blob/main/docs/INTERNALS.md) and
  [`MAPPING-SCHEMA.md`](https://github.com/fairscape/fairscape_conversion/blob/main/MAPPING-SCHEMA.md).

Source: [github.com/fairscape/fairscape_conversion](https://github.com/fairscape/fairscape_conversion)
