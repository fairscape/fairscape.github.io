...
To enable these features, add the keys to `deploy/docker_compose.env` and restart. See the [Configuration page](configuration.md#optional-features) for full details.
